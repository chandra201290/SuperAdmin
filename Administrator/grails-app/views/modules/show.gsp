...
<html>
    ...
    <body>
        ...
        <div id="show-modules" class="content scaffold-show" role="main">
            ...
            <f:display bean="modules" />
            <g:form resource="${this.modules}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.modules}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
